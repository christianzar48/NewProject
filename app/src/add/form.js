    ...
    <div className="Form">
        <div className='form-container'>
            ...
            <form onSubmit={formSubmit} className="add-form">
                ...
                <input onChange={handleInputChange} value={formData.hp} placeholder="HP" type="number" name="hp" max="255" min="0" />
                <input onChange={handleInputChange} value={formData.atk} placeholder="ATK" type="number" name="atk" max="255" min="0" />
                <input onChange={handleInputChange} value={formData.def} placeholder="DEF" type="number" name="def" max="255" min="0" />
                <input onChange={handleInputChange} value={formData.satk} placeholder="SATK" type="number" name="satk" max="255" min="0" />
                <input onChange={handleInputChange} value={formData.sdef} placeholder="SDEF" type="number" name="sdef" max="255" min="0" />
                <input onChange={handleInputChange} value={formData.spd} placeholder="SPD" type="number" name="spd" max="255" min="0" />
